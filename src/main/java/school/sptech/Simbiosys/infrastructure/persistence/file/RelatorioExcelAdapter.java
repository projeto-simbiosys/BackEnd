package school.sptech.Simbiosys.infrastructure.persistence.file;
...
public class RelatorioExcelAdapter {
    ...
    public static byte[] exportarParaExcel(List<RelatorioEntity> relatorios) throws IOException {
    ...
    public static String gerarRelatorioExcel(List<RelatorioEntity> relatorios, String nomeArquivo) throws IOException {
    ...
    private static Workbook gerarWorkbook(List<RelatorioEntity> relatorios) {
